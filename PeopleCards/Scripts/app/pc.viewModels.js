pc.viewModels.CardList = function (){
    ...
    self.gettingData = function(){
        ...
        var data = [
            ...
            { name: "Aja Shamblee", office: "Chicago", serviceLine: "Visual Design", photo: self.imagePath + "Aja Shamblee.JPG", origin: "Rightpoint" },
            { name: "Aleksandr Zebrov", office: "Chicago", serviceLine: "Managed Services", photo: self.imagePath + "Alex Zebrov.jpg", origin: "Rightpoint" },
            { name: "Alex Swarthout", office: "Chicago", serviceLine: "Delivery Support/Operations", photo: self.imagePath + "Alex Swarthout.jpg", origin: "Rightpoint" },
            { name: "Ali Quadri", office: "Chicago", serviceLine: "User Experience", photo: self.imagePath + "Ali Quadri.jpg", origin: "Rightpoint" },
            ...
            { name: "Andy Bateman", office: "Chicago", serviceLine: "Application Development", photo: self.imagePath + "Andy Bateman.jpg", origin: "Rightpoint" },
            ...
            { name: "Austin Smith", office: "Chicago", serviceLine: "Visual Design", photo: self.imagePath + "Austin Smith.jpg", origin: "Rightpoint" },
            ...
            { name: "Barbara Kubas", office: "Chicago", serviceLine: "Application Development", photo: self.imagePath + "Barbara Kubas.jpg", origin: "Rightpoint" },
            { name: "Bartel Welch", office: "Detroit", serviceLine: "Application Development", photo: self.imagePath + "Bartel Welch.jpg", origin: "Rightpoint" },
            ...
            { name: "Brian Bennewitz", office: "Chicago", serviceLine: "Application Development", photo: ((self.isChrome || self.isSafari) ? self.imagePath + "Brian Bennewitz.gif" : self.imagePath + "Brian Bennewitz.jpg"), origin: "Rightpoint" },
            ...
            { name: "Carlee Wolfe", office: "Chicago", serviceLine: "Change Management", photo: self.imagePath + "Carlee Wolfe.jpg", origin: "Rightpoint" },
            ...
            { name: "Christian Fitzsimonds", office: "Detroit", serviceLine: "Application Development", photo: self.imagePath + "Christian Fitzsimonds.jpg", origin: "Rightpoint" },
            ...
            { name: "Darren Berry", office: "Detroit", serviceLine: "Cloud and Infrastructure", photo: self.imagePath + "Darren Berry.jpg", origin: "Rightpoint" },
            { name: "David Domm", office: "Chicago", serviceLine: "R&D", photo: self.imagePath + "David Domm.jpg", origin: "Rightpoint" },
            ...
            { name: "Dev Deol", office: "Chicago", serviceLine: "Application Development", photo: self.imagePath + "Dev Deol.jpg", origin: "Rightpoint" },
            { name: "Drew Null", office: "Chicago", serviceLine: "Application Development", photo: self.imagePath + "Drew Null.JPG", origin: "Rightpoint" },
            { name: "Emily Olson", office: "Chicago", serviceLine: "Application Development", photo: self.imagePath + "Emily Olson.jpg", origin: "Rightpoint" },
            ...
            { name: "Gautam Jaiswal", office: "Chicago", serviceLine: "Application Development", photo: self.imagePath + "Gautam Jaiswal.jpg", origin: "Rightpoint" },
            { name: "Gina Lee", office: "Chicago", serviceLine: "Visual Design", photo: self.imagePath + "Gina Lee.jpg", origin: "Rightpoint" },
            ...
            { name: "Jaime Velez", office: "Chicago", serviceLine: "SharePoint", photo: self.imagePath + "Jaime Velez.jpg", origin: "Rightpoint" },
            { name: "James Mburu", office: "Chicago", serviceLine: "Business Intelligence", photo: self.imagePath + "James Mburu.jpg", origin: "Rightpoint" },
            { name: "James Mueller", office: "Chicago", serviceLine: "Client Partner", photo: self.imagePath + "Jay Mueller.jpg", origin: "Rightpoint" },
            ...
            { name: "Jeff Small", office: "Chicago", serviceLine: "Project Management", photo: self.imagePath + "Jeff Small.jpg", origin: "Rightpoint" },
            ...
            { name: "Jesse Murray", office: "Detroit", serviceLine: "Application Development", photo: self.imagePath + "Jesse Murray.jpg", origin: "Rightpoint" },
            ...
            { name: "Jimmy Hopton", office: "Chicago", serviceLine: "Visual Design", photo: self.imagePath + "Jimmy Hopton.jpg", origin: "Rightpoint" },
            ...
            { name: "John Ingraffia", office: "Chicago", serviceLine: "SharePoint", photo: self.imagePath + "John Ingraffia.jpg", origin: "Rightpoint" },
            ...
            { name: "Krystal Blesi", office: "Chicago", serviceLine: "Salesforce", photo: self.imagePath + "Krystal Blesi.jpg", origin: "Rightpoint" },
            { name: "Laraib Jafri", office: "Chicago", serviceLine: "Salesforce", photo: self.imagePath + "Laraib Jafri.jpg", origin: "Rightpoint" },
            { name: "Laurel Petty", office: "Chicago", serviceLine: "Visual Design", photo: self.imagePath + "Laurel Petty.jpg", origin: "Rightpoint" },
            ...
            { name: "Leslie Lockett", office: "Detroit", serviceLine: "Delivery Support/Operations", photo: self.imagePath + "Leslie Lockett.jpg", origin: "Rightpoint" },
            ...
            { name: "Nick Carlson", office: "Chicago", serviceLine: "SharePoint", photo: self.imagePath + "Nick Carlson.jpg", origin: "Rightpoint" },
            { name: "Nick Groos", office: "Chicago", serviceLine: "Application Development", photo: self.imagePath + "Nick Groos.jpg", origin: "Rightpoint" },
            ...
            { name: "Owen Craig", office: "Chicago", serviceLine: "Application Development", photo: self.imagePath + "Owen Craig.jpg", origin: "Rightpoint" },
            ...
            { name: "Rebecca Steurer", office: "Chicago", serviceLine: "Content Strategy", photo: self.imagePath + "Rebecca Steurer.jpg", origin: "Rightpoint" },
            ...
            { name: "Rich Grenwick", office: "Detroit", serviceLine: "Application Development", photo: self.imagePath + "Rich Grenwick.jpg", origin: "Rightpoint" },
            { name: "Robin Schaffer", office: "Denver", serviceLine: "Business Development", photo: self.imagePath + "Robin Schaffer.jpg", origin: "Rightpoint" },
            ...
            { name: "Sanjeev Karmacharya", office: "Chicago", serviceLine: "Application Development", photo: self.imagePath + "Sanjeev Karmacharya.jpg", origin: "Rightpoint" },
            ...
            { name: "Scott Rojas", office: "Chicago", serviceLine: "Project Management", photo: self.imagePath + "Scott Rojas.jpg", origin: "Rightpoint" },
            ...
            { name: "Sreeni Amrutur", office: "Detroit", serviceLine: "SharePoint", photo: self.imagePath + "Sreeni Amrutur.jpg", origin: "Rightpoint" },
            { name: "Steve Dykstra", office: "Detroit", serviceLine: "Project Management", photo: self.imagePath + "Steve Dykstra.jpg", origin: "Rightpoint" },
            ...
            { name: "Steven Mierop", office: "Chicago", serviceLine: "Application Development", photo: self.imagePath + "Steven Mierop.jpg", origin: "Rightpoint" },
            { name: "Steven Schnorr", office: "Chicago", serviceLine: "Salesforce", photo: self.imagePath + "Steven Schnorr.jpg", origin: "Rightpoint" },
            { name: "Suman Kamath", office: "Denver", serviceLine: "Project Management", photo: self.imagePath + "Suman Kamath.jpg", origin: "Rightpoint" },
            { name: "Syed Belgam", office: "Chicago", serviceLine: "Managed Services", photo: self.imagePath + "Syed Belgam.jpg", origin: "Rightpoint" },
            ...
            { name: "Daniel Nedelcu", office: "Atlanta", serviceLine: "Development", photo: self.imagePath + "Daniel Nedelcu.jpg", origin: "Oasis" },
            ...
            { name: "Gaurav Agarwal", office: "Jaipur, India", serviceLine: "Development", photo: self.imagePath + "Gaurav Agarwal.jpg", origin: "Oasis" },
            ...
            { name: "Jared Arnofsky", office: "Boston", serviceLine: "Development", photo: self.imagePath + "Jared Arnofsky.jpg", origin: "Oasis" },
            ...
            { name: "John Schneider", office: "Atlanta", serviceLine: "Development", photo: self.imagePath + "John Schneider.jpg", origin: "Oasis" },
            ...
            { name: "Mahendra Shekhawat", office: "Jaipur, India", serviceLine: "Development", photo: self.imagePath + "Mahendra Shekhawat.jpg", origin: "Oasis" },
            ...
            { name: "Paul Mathai", office: "Boston", serviceLine: "QA", photo: self.imagePath + "Paul Mathai.jpg", origin: "Oasis" },
            ...
            { name: "Praveen Soni", office: "Jaipur, India", serviceLine: "Development", photo: self.imagePath + "Praveen Soni.jpg", origin: "Oasis" },
            ...
            { name: "Rishiraj Shekhawat", office: "Jaipur, India", serviceLine: "Development", photo: self.imagePath + "Rishiraj Shekhawat.jpg", origin: "Oasis" },
            ...
            { name: "Sarvesh Jain", office: "Atlanta", serviceLine: "Development", photo: self.imagePath + "Sarvesh Jain.jpg", origin: "Oasis" },
            { name: "Simon Smith", office: "Boston", serviceLine: "Finance/HR", photo: self.imagePath + "Simon Smith.jpg", origin: "Oasis" },
            ...
            { name: "Wendy Karlyn", office: "Boston", serviceLine: "Delivery", photo: self.imagePath + "Wendy Karlyn.jpg", origin: "Oasis" }
    ...
    self.init = function () {
        ...
        self.isSafari = /Safari/.test(navigator.userAgent) && /Apple Computer/.test(navigator.vendor);
