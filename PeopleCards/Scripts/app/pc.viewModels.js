pc.viewModels.CardList = function (){
    ...
    self.selectedServiceLine = ko.observable("All");
    ...
    self.selectedOffice = ko.observable("Anywhere");
    self.origins = ko.observableArray(["All", "Rightpoint", "Oasis"]);
    self.selectedOrigin = ko.observable("All");
