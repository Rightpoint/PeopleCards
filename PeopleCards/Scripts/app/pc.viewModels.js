pc.viewModels.CardList = function (){
    ...
    self.gettingData = function(){
        ...
        var data = [
            ...
            { name: "Daniel Nedelcu", office: "Atlanta", serviceLine: "Development", photo: self.imagePath + "DanielNedelcu.jpg", origin: "Oasis" },
            ...
            { name: "Sarvesh Jain", office: "Atlanta", serviceLine: "Development", photo: self.imagePath + "SarveshJain.jpg", origin: "Oasis" },
            { name: "Simon Smith", office: "Boston", serviceLine: "Finance/HR", photo: self.imagePath + "SimonSmith.jpg", origin: "Oasis" },
            ...
            { name: "TJ Sugnet", office: "San Francisco", serviceLine: "Strategy & User Experience", photo: self.imagePath + "TJSugnet.jpg", origin: "Oasis" },
